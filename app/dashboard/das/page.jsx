        ...
        <div style={{ padding: "20px 24px 24px" }} className="flex flex-col gap-4">
          ...
          <div className="flex gap-3" style={{ marginTop: 4 }}>
            ...
            <button
              ...
              style={{ border: "none", backgroundColor: "#FF5C00", color: "#1C1C1C", fontWeight: 600, fontSize: 14 }}
            >
                  ...
                  {status !== "pago" && (
                    <>
                      ...
                      <button
                        ...
                        style={{ backgroundColor: "#FF5C00", color: "#1C1C1C", fontWeight: 500, border: "none", whiteSpace: "nowrap" }}
                      >
                        Marcar como pago
                      </button>
                    </>
