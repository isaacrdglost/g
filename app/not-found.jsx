      ...
      >
        <div className="flex items-center justify-center gap-2.5 mb-10">
          <div
            ...
            style={{ width: 34, height: 34, borderRadius: 9, backgroundColor: "#E05E1A", color: "#1C1C1C", fontSize: 15 }}
          >
            G
          </div>
        ...
        <Link
          ...
          style={{ backgroundColor: "#E05E1A", color: "#1C1C1C", fontWeight: 600, fontSize: 15, textDecoration: "none" }}
        >
