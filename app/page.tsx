            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span style={{ fontSize: 11, color: "#FF5C00", fontWeight: 500, marginTop: 4, display: "block" }}>
                    Vence em 8 dias
                  </span>
                </div>
                <div
                ...
                {[32, 45, 28, 52, 40, 60, 38, 55, 44, 68, 50, 72].map((h, i) => (
                  <div
                    ...
                    style={{
                      flex: 1,
                      height: `${h}%`,
                      backgroundColor: i === 11 ? "#FF5C00" : "#EBEBEB",
                      borderRadius: 3,
                    }}
                  />
                ))}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#CC4400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 20V10" />
                <path d="M18 20V4" />
                <path d="M6 20v-4" />
              </svg>
