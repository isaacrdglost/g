    ...
    <>
      ...
      <div className="auth-map">
        <svg viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <circle cx="500" cy="300" r="10" stroke="rgba(212,80,10,0.3)" strokeWidth="0.5" fill="none">
          ...
          <circle cx="250" cy="190" r="1.5" fill="rgba(212,80,10,0.5)" />
          <circle cx="700" cy="160" r="1" fill="rgba(212,80,10,0.4)" />
          <circle cx="1100" cy="380" r="1.5" fill="rgba(212,80,10,0.25)" />
          <circle cx="350" cy="620" r="1" fill="rgba(212,80,10,0.4)" />
          <circle cx="680" cy="730" r="1.5" fill="rgba(212,80,10,0.4)" />
          <circle cx="1150" cy="620" r="1" fill="rgba(212,80,10,0.3)" />
          <circle cx="200" cy="800" r="1" fill="rgba(212,80,10,0.3)" />
          <circle cx="1300" cy="700" r="1" fill="rgba(212,80,10,0.4)" />
          ...
          <text x="108" y="395" fill="rgba(212,80,10,0.4)" fontSize="7" fontFamily="var(--font-dm-mono)">01</text>
          <text x="558" y="375" fill="rgba(212,80,10,0.3)" fontSize="7" fontFamily="var(--font-dm-mono)">02</text>
